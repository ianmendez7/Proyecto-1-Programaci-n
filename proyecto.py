...
El código recibe la cantidad de días, el nombre de los equipos y el
resultado de los equipos.
Hace una sumatoria y le asigna puntos a cada
equipo, después devuelve los equipos en una tabla de mayor a menor
mostrando las puntuaciones de cada uno.
"""
...
def registrar_equipos():
    ...
    for i in range(cantidad):
        ...
        """
        # Se guarda el equipo como [nombre, puntos_iniciales]
        """
...
#Función para ordenar puntuaciones
